''' Implement a class called Bankaccount represents a bank account.The class should be private
attributes for account number, account holder name,and account balance,Include methods to
deposit money withdraw money,and display the amount balance,Ensure that the account balance
